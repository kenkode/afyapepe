...
<div class="row">
    <div class="col-lg-12">
     ...
     <div class="col-lg-3">
    <a class="btn btn-primary btn-lg btn-block" data-toggle="tab" href="#tab-11"><i class="fa fa-database"></i>LABORATORY TEST HISTORY</a>
       </div>
       <div class="col-lg-3">
      <a class="btn btn-primary btn-lg btn-block" data-toggle="tab" href="#tab-1"><i class="fa fa-database"></i>RADIOLOGY TEST HISTORY</a>
         </div>
    <div class="col-lg-6">
        ...
        @include('doctor.testH')
                <div id="tab-2" class="tab-pane">
                    <div class="panel-body">
                      ...
                      <input type="checkbox" name="colorCheckbox" value="MRI">Radiology
