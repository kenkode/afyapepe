<!--left menu start-->
 ...
 <li class="active"><a href="{{ url('/') }}"<i class="fa fa-home"></i>  <span>ADMIN-Dashboard</span></a></li>
...
<li><a href="{{ url('/pharmacy') }}"><i class="fa fa-edit"></i> <span>PHARM</span><span class="fa arrow"></span></a></li>
<li><a href="{{ url('/manufacturer') }}"><i class="fa fa-edit"></i> <span>MANUFACTURER</span><span class="fa arrow"></span></a></li>
<li><a href="{{ url('/patient') }}"><i class="fa fa-edit"></i> <span>PATIENT</span><span class="fa arrow"></span></a></li>
