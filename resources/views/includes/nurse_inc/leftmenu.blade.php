       ...
       <li   <?php $data = DB::table("patients")->count();
                ?>
                    <li>
                     ...
                     <a href="{{ URL::to('newpatient') }}"><i class="fa fa-users"></i> <span>New Patients</span>    <span class="badge"><?php echo $data; ?></span>
                     <a href="{{ URL::to('waitingList')}}">
                     <i class="fa fa-users"></i> <span>Waiting List</span>   <span class="badge">0</span>
