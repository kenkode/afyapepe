<!--left menu start-->
       ...
       $total = DB::table('prescription_filled_status')
        ->where('prescription_filled_status.date','>=',$today)->sum('amount');
     ?>
                    ...
                    <li>
                      ...
                      <a href="{{ URL::to('pharmacy')}}"><i class="fa fa-users"></i> <span>Total Patients</span>       <span class="badge"><?php echo $data; ?></span>
                        <a href="{{ URL::to('totalsales') }}"><i class="fa fa-shopping-cart"></i> <span>Today Sales</span>   <span class="badge"><?php echo $total; ?></span>
